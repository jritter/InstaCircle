...
public class NetworkInfoFragment extends Fragment implements
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		networkUUID = (TextView) layout.findViewById(R.id.network_uuid);
		...
		broadcastAddress = (TextView) layout.findViewById(R.id.broadcast_address);
		
		networkUUID.setText(dbHelper.getOpenConversationUUID());
		networkSSID.setText(preferences.getString("SSID", "N/A"));
		networkPassword.setText(dbHelper.getCipherKey());
		participantIdentification.setText(preferences.getString("identification", "N/A"));
